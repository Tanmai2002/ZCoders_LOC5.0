...
export const Navbar = params => {
  ...
  return (<div className='flex bg-white sticky top-0 z-50 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-50 justify-center pt-4 px-30'>
  <div className='w-screen flex justify-between items-center px-20 p-2'>
      ...
      <div className='flex items-center gap-5'>
        ...
        <button className='w-24 p-2 bg-transparent cursor-pointer' onClick={()=>{params.setConnected(false)}}>Log Out</button>
      </div>
  </div>
</div>
)
